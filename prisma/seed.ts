...
async function seedUsers() {
  ...
  const guide4 = await prisma.user.create({
    data: {
      ...
      guides: {
        create: {
          verification_documents: ['license_rf_2024.pdf', 'archaeology_cert.pdf'],
          languages_spoken: ['English', 'Sinhala', 'Tamil'],
  ...
  const guide6 = await prisma.user.create({
    data: {
      ...
      guides: {
        create: {
          verification_documents: ['license_sb_2024.pdf', 'plantation_cert.pdf'],
  ...
  return { admin, moderator, guide1, guide2, guide3, guide4, guide5, guide6, traveler1, traveler2, traveler3, vendor1, vendor2, vendor3 };
}
...
async function seedTourPackages(users: any) {
  ...
  const tourPackagesData = [
    ...
    },
    {
      ...
      description: 'Full-day wildlife safari in Yala National Park with opportunities to spot leopards, elephants, and exotic birds.',
      price: 9500.00,
    ...
    },
    {
      ...
      description: 'Experience authentic Sri Lankan cuisine through cooking classes, spice garden visits, and traditional meals.',
      price: 6800.00,
    ...
    },
    {
      ...
      description: 'Explore the scenic hill country, visit tea plantations, and learn about Ceylon tea production.',
      price: 8200.00,
    ...
    },
    {
      ...
      description: 'Witness the famous elephant gathering at Minneriya National Park during the dry season.',
      price: 7800.00,
    ...
    },
    {
      ...
      description: 'Journey through the ancient sacred city of Anuradhapura with its magnificent stupas and ruins.',
      price: 9200.00,
      duration_minutes: 480,
      status: 'pending_approval' as const,
    ...
    },
    {
      ...
      description: 'Experience the bustling fish market and relax on beautiful Negombo beach.',
      price: 4500.00,
    ...
    },
    {
      ...
      description: 'Early morning whale watching trip from Mirissa with chances to see blue whales and dolphins.',
      price: 11000.00,
      duration_minutes: 360,
      status: 'pending_approval' as const,
    ...
    },
    {
      ...
      description: 'Challenging hike to Ella Rock with breathtaking views of the hill country landscape.',
      price: 5500.00,
      duration_minutes: 420,
      status: 'pending_approval' as const,
    ...
    },
    {
      ...
      description: 'Explore the magnificent cave temples of Dambulla with ancient Buddhist paintings and statues.',
      price: 6200.00,
      duration_minutes: 300,
      status: 'pending_approval' as const,
    ...
    },
    {
      ...
      description: 'Immerse yourself in rural Sri Lankan life with village activities and home-cooked meals.',
      price: 3800.00,
      duration_minutes: 480,
      status: 'pending_approval' as const,
    ...
    },
    {
      ...
      description: 'Spiritual night climb to Adams Peak to witness the spectacular sunrise from the sacred summit.',
      price: 8900.00,
      duration_minutes: 720,
      status: 'pending_approval' as const,
    ...
    },
    {
      ...
      description: 'Discover the diverse street food scene of Colombo with tastings from local vendors and markets.',
      price: 3200.00,
    ...
    // REJECTED PACKAGES (4)
    {
      ...
      rejection_reason: 'Insufficient detail in itinerary and overpriced for duration offered.'
    },
    {
      guide_id: guides[3].id,
      ...
      rejection_reason: 'Tour duration too short for the number of sites claimed to be covered.'
    },
    {
      guide_id: guides[4].id,
      ...
      rejection_reason: 'Lacks unique value proposition and proper activity planning.'
    },
    {
      guide_id: guides[5].id,
      ...
      rejection_reason: 'Missing safety protocols and required certifications for adventure activities.'
    }
  ];
...
async function seedTourStops(packages: any, locations: any, media: any) {
  ...
  const tourStopsData = [
    // Package 1: Colombo Cultural (3 stops)
    {
      ...
      description: 'Start your journey at the iconic seafront promenade with stunning ocean views and local street food.',
    ...
    },
    {
      ...
      description: 'Visit the national monument commemorating Sri Lanka\'s independence with beautiful architecture.',
    ...
    },
    {
      ...
      description: 'Explore one of Colombo\'s most important Buddhist temples with its eclectic architecture.',
    ...
    },
    {
      ...
      description: 'Explore the magnificent botanical gardens with rare plants and beautiful landscapes.',
    ...
    },
    {
      ...
      description: 'Peaceful walk around the scenic artificial lake in the heart of Kandy.',
    ...
    },
    {
      ...
      description: 'Learn about Sri Lankan spices and their traditional uses in cooking and medicine.',
    ...
    },
    {
      ...
      description: 'Explore the cave temple complex with ancient Buddhist art and statues.',
    ...
    },
    {
      ...
      description: 'Discover the ruins of the ancient capital with well-preserved statues and structures.',
    ...
    // Package 4: Yala Wildlife (2 stops)
    {
      ...
      description: 'Main safari area with highest leopard density in the world.',
    ...
    },
    {
      ...
      description: 'Coastal area within the park where elephants come to drink and bathe.',
      location_id: locations[16].id
    },
    ...
    // Package 5: Culinary Journey (3 stops)
    {
      ...
      description: 'Learn about Sri Lankan spices and traditional cooking methods.',
      location_id: locations[7].id
    },
    {
      package_id: packages[4].id,
      ...
      description: 'Hands-on cooking experience preparing authentic Sri Lankan dishes.',
      location_id: locations[6].id
    },
    {
      package_id: packages[4].id,
      ...
      description: 'Explore local markets and learn about fresh ingredients used in Sri Lankan cuisine.',
    ...
    },
    {
      ...
      description: 'Tour a working tea plantation and learn about Ceylon tea production.',
    ...
    },
    {
      ...
      description: 'Explore the beautiful botanical garden with temperate climate plants.',
    ...
    },
    {
      ...
      description: 'Visit the plateau with unique ecosystem and World\'s End viewpoint.',
    ...
    },
    {
      ...
      description: 'Ancient reservoir where elephants gather to drink and bathe.',
      location_id: locations[17].id
    },
    ...
    // Package 9: Anuradhapura Sacred (4 stops)
    {
      ...
      description: 'Explore the ancient capital and first kingdom of Sri Lanka.',
    ...
    },
    {
      ...
      description: 'Pay respects at the sacred Bodhi tree, grown from a cutting of the original tree under which Buddha attained enlightenment.',
      location_id: locations[14].id
    },
    {
      package_id: packages[8].id,
      ...
      description: 'Explore the ruins of one of the most important monastic complexes of ancient Sri Lanka.',
      location_id: locations[14].id
    },
    ...
    // Package 10: Negombo Fish Market (2 stops)
    {
      ...
      description: 'Experience the bustling morning fish market with fresh catches.',
    ...
    },
    {
      ...
      description: 'Relax on the golden sandy beach and watch traditional fishing boats.',
    ...
    // Package 11: Mirissa Whale Watching (2 stops)
    {
      ...
      description: 'Board the boat for whale watching adventure in the deep blue sea.',
    ...
    },
    {
      ...
      description: 'Relax on the beautiful crescent-shaped beach after whale watching.',
    ...
    },
    {
      ...
      description: 'Reach the summit for breathtaking 360-degree views of hill country.',
      location_id: locations[20].id
    },
    {
      package_id: packages[11].id,
      ...
      description: 'Visit the iconic railway bridge and watch trains pass through.',
    ...
    // Package 13: Dambulla Cave Temple (2 stops)
    {
      ...
      description: 'Explore the five caves with ancient Buddhist paintings and statues.',
      location_id: locations[13].id
    },
    {
      package_id: packages[12].id,
      ...
      description: 'Learn about the history and significance of the cave temples.',
      location_id: locations[13].id
    },
    ...
    // Package 14: Traditional Village (3 stops)
    {
      ...
      description: 'Immerse yourself in authentic rural Sri Lankan village life.',
    ...
    },
    {
      ...
      description: 'Learn traditional cooking methods and enjoy home-cooked meals.',
      location_id: locations[32].id
    },
    {
      package_id: packages[13].id,
      ...
      description: 'Try your hand at traditional crafts like pottery and weaving.',
      location_id: locations[32].id
    },
    ...
    },
    {
      ...
      description: 'Reach the sacred summit and witness the spectacular sunrise.',
    ...
    },
    {
      ...
      description: 'Experience authentic Sri Lankan tea culture at a local tea shop.',
      location_id: locations[2].id
    },
    {
      package_id: packages[15].id,
      ...
      description: 'End the tour with traditional Sri Lankan sweets and desserts.',
      location_id: locations[3].id
    },
  ...
  console.log(`✅ Created ${tourStopsData.length} tour stops across all 20 packages`);
}
...
async function seedPayments(users: any, packages: any) {
  ...
  const publishedPackages = packages.filter((pkg: any) => pkg.status === 'published');
  ...
  await prisma.review.createMany({
    data: [
      ...
      },
      {
        ...
        user_id: users.traveler3.id,
        rating: 5,
        comments: 'Incredible ancient sites! Michael\'s expertise in archaeology made this tour unforgettable.',
      ...
      },
      {
        ...
        user_id: users.traveler1.id,
        rating: 4,
        comments: 'Great wildlife experience. Saw leopards, elephants, and many birds. Priya was an excellent guide.',
      ...
      },
      {
        ...
        user_id: users.traveler2.id,
        rating: 5,
        comments: 'Amazing culinary experience! Learned so much about Sri Lankan spices and cooking techniques.',
    ...
    data: [
      {
        ...
        description: 'A hidden beach cove perfect for watching sunsets away from crowds.',
        status: 'approved',
      ...
      },
      {
        ...
        description: 'A secluded waterfall accessible via a short trek from Ella town.',
        status: 'approved',
      ...
      },
      {
        ...
        description: 'A lesser-known viewpoint offering panoramic views of tea plantations.',
        status: 'pending',
  ...
  await prisma.pOI.createMany({
    data: [
      ...
      },
      {
        ...
        description: 'Premium transportation services for tourists across Sri Lanka.',
        type: 'transport',
        status: 'approved',
      ...
      },
      {
        ...
        category: 'Accommodation',
        description: 'Sustainable eco-lodge in the heart of Sri Lanka\'s hill country.',
        type: 'hotel',
...
async function seedReports(users: any, packages: any) {
  ...
  const rejectedPackages = packages.filter((pkg: any) => pkg.status === 'rejected');
  ...
  await prisma.report.createMany({
    data: [
      ...
      },
      {
        ...
        status: 'resolved',
        description: 'Package content was insufficient and pricing was not justified.',
...
async function main() {
  try {
    ...
    console.log('\n📊 Summary:');
    console.log('- 12 Users created (1 admin, 1 moderator, 6 guides, 3 travelers, 3 vendors)');
    ...
    console.log(`- ${totalStops} Tour stops created for ALL packages (including pending and rejected)`);
    ...
    console.log(`│ Guide 3     │ guide3@roamio.com   │ ${testPasswords.guide}      │`);
    console.log(`│ Guide 4     │ guide4@roamio.com   │ ${testPasswords.guide}      │`);
    console.log(`│ Guide 5     │ guide5@roamio.com   │ ${testPasswords.guide}      │`);
    console.log(`│ Guide 6     │ guide6@roamio.com   │ ${testPasswords.guide}      │`);
    ...
    console.log(`│ Traveler 3  │ traveler3@roamio.com│ ${testPasswords.traveler}  │`);
    console.log(`│ Vendor 1    │ vendor1@roamio.com  │ ${testPasswords.vendor}     │`);
    console.log(`│ Vendor 2    │ vendor2@roamio.com  │ ${testPasswords.vendor}     │`);
    console.log(`│ Vendor 3    │ vendor3@roamio.com  │ ${testPasswords.vendor}     │`);
    console.log('└─────────────┴─────────────────────┴───────────────┘');
